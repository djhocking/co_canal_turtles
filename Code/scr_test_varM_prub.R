...
if(testing) {
  load(file = paste0("Data/Derived/all_site_testing_prub", run_date, ".RData"))
} else {
  load(file = "Data/Derived/all_site_prub.RData")
}
...
df_M # PRUB: Max df$M = 1200, caught 111 individuals, so ids go to 111
