...
if(testing) {
  ...
  save(Species, recaptured, Z_st, s_st, trap_locs, augs, sex, psi_st, psi_sex_st, EM_array, n_days, n_sites, n_traps_site, n_ind_site, M, xlim, run_date, df_M, caps_day, file = paste0("Data/Derived/", Species, "_all_site_", run_date, ".RData")) # other objects needed?
}
